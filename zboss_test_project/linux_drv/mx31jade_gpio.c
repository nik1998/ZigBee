 ...
 *		06/17/2010	Rachel Lo
 *					enable ATA related pins for CF card use
 *		09/10/2010	rachel lo
 *					add functions to turn on/off the panel power
 */

/*
 *create for seting ISP1504 power
 *		07/08/2010	Yanzhang Chen
 */
...
void gpio_uart_active(int port, int no_irda)
{
	...
	case 0:
		...
		mxc_request_iomux(MX31_PIN_CTS1, OUTPUTCONFIG_FUNC,
				  INPUTCONFIG_FUNC);
#if (!defined(CONFIG_FB_MXC_JADE_WQVGA) && !defined(CONFIG_MACH_MX31JADE_RTRS))
		...
		mxc_request_iomux(MX31_PIN_RI_DCE1, OUTPUTCONFIG_FUNC,
				  INPUTCONFIG_FUNC);
#ifndef CONFIG_FB_MXC_JADE_WQVGA
...
void gpio_i2c_active(int i2c_num)
{
	...
	case 1:
		...
		mxc_request_iomux(MX31_PIN_RI_DTE1, OUTPUTCONFIG_ALT2,INPUTCONFIG_ALT2);
		mxc_request_iomux(MX31_PIN_DCD_DTE1, OUTPUTCONFIG_ALT2, INPUTCONFIG_ALT2);
		break;
	case 2:
...
void gpio_i2c_inactive(int i2c_num)
{
	...
	case 0:
		break;
	case 1:
		mxc_free_iomux(MX31_PIN_RI_DTE1, OUTPUTCONFIG_GPIO, INPUTCONFIG_GPIO);
		mxc_free_iomux(MX31_PIN_DCD_DTE1, OUTPUTCONFIG_GPIO, INPUTCONFIG_GPIO);
		break;
	case 2:
...
{
	if (id == 0) {
		iomux_config_mux(MX31_PIN_USB_BYP, OUTPUTCONFIG_GPIO,
				 INPUTCONFIG_GPIO);
		return IOMUX_TO_IRQ(MX31_PIN_USB_BYP);
	} else {
		iomux_config_mux(MX31_PIN_USB_BYP, OUTPUTCONFIG_GPIO,
				 INPUTCONFIG_GPIO);
		return IOMUX_TO_IRQ(MX31_PIN_USB_BYP);
...
#ifndef CONFIG_MACH_MX31JADE
	temp = PBC_BCTRL1_LCDON;
	__raw_writew(temp, PBC_BASE_ADDRESS + PBC_BCTRL1_SET);
#elif defined(CONFIG_MACH_MX31JADE_RTRS)
/*	add PPWR and BL-ON LVDS_ON gpio control */
/*set LVDS on */
	mxc_request_iomux(MX31_PIN_DTR_DCE1, OUTPUTCONFIG_GPIO,INPUTCONFIG_GPIO);
	gpio_direction_output(IOMUX_TO_GPIO(MX31_PIN_DTR_DCE1), 1);
/*set PPWR*/
	mxc_request_iomux(MX31_PIN_SRX0, OUTPUTCONFIG_GPIO,INPUTCONFIG_GPIO);
	gpio_direction_output(IOMUX_TO_GPIO(MX31_PIN_SRX0), 1);
/*set BL-ON gpio */
	mxc_request_iomux(MX31_PIN_ATA_DMACK, OUTPUTCONFIG_GPIO,INPUTCONFIG_GPIO);
	gpio_direction_output(IOMUX_TO_GPIO(MX31_PIN_ATA_DMACK), 1);
#else
/*	add PPWR and BL-ON gpio control */
	mxc_request_iomux(MX31_PIN_GPIO1_4, OUTPUTCONFIG_GPIO,INPUTCONFIG_GPIO);
	gpio_direction_output(IOMUX_TO_GPIO(MX31_PIN_GPIO1_4), 1);
/*set BL-ON gpio */
	iomux_config_gpr(MUX_PGP_CSPI_BB, false);
	mxc_request_iomux(MX31_PIN_DTR_DTE1, OUTPUTCONFIG_GPIO,INPUTCONFIG_GPIO);
	gpio_direction_output(IOMUX_TO_GPIO(MX31_PIN_DTR_DTE1), 0);
#endif	
}
...
#elif defined(CONFIG_MACH_MX31JADE_RTRS)
  //Turn off BL and PPWR
  gpio_direction_output(IOMUX_TO_GPIO(MX31_PIN_SRX0), 0);
  gpio_direction_output(IOMUX_TO_GPIO(MX31_PIN_ATA_DMACK), 0);
  mxc_free_iomux(MX31_PIN_SRX0, OUTPUTCONFIG_GPIO,INPUTCONFIG_GPIO);        
	mxc_free_iomux(MX31_PIN_ATA_DMACK, OUTPUTCONFIG_GPIO,INPUTCONFIG_GPIO);
#else 
	iomux_config_gpr(MUX_PGP_CSPI_BB, false);
	gpio_direction_output(IOMUX_TO_GPIO(MX31_PIN_DTR_DTE1), 0);
	mxc_free_iomux(MX31_PIN_GPIO1_4, OUTPUTCONFIG_GPIO,INPUTCONFIG_GPIO);        
	mxc_free_iomux(MX31_PIN_DTR_DTE1, OUTPUTCONFIG_GPIO,INPUTCONFIG_GPIO);
#endif
}

#if defined CONFIG_MACH_MX31JADE_UL
void gpio_lcd_power_active(void)
{
	mxc_request_iomux(MX31_PIN_SRX0, OUTPUTCONFIG_GPIO,INPUTCONFIG_GPIO);
	gpio_direction_output(IOMUX_TO_GPIO(MX31_PIN_SRX0), 1);
}
void gpio_lcd_power_inactive(void)
{
	mxc_request_iomux(MX31_PIN_SRX0, OUTPUTCONFIG_GPIO,INPUTCONFIG_GPIO);
	gpio_direction_output(IOMUX_TO_GPIO(MX31_PIN_SRX0), 0);
}
...
#endif
	mxc_iomux_set_gpr(MUX_PGP_ATA_7 | MUX_PGP_ATA_6 | MUX_PGP_ATA_9 |
			  MUX_PGP_ATA_1, true);
	/*
...
/* modify for enable OE of SN74AVC8T245DGVR on Jade*/
	mxc_request_iomux(MX31_PIN_GPIO1_0, OUTPUTCONFIG_GPIO,INPUTCONFIG_GPIO);        
	gpio_direction_output(IOMUX_TO_GPIO(MX31_PIN_GPIO1_0), 0);
/*enable CF card CD2*/
	mxc_request_iomux(MX31_PIN_GPIO1_1, OUTPUTCONFIG_GPIO,INPUTCONFIG_GPIO);
    gpio_direction_output(IOMUX_TO_GPIO(MX31_PIN_GPIO1_1), 0);
}
...
void gpio_ata_inactive(void)
{
	...
	mxc_request_iomux(MX31_PIN_KEY_COL4, OUTPUTCONFIG_GPIO, INPUTCONFIG_GPIO);	// ATA_DMARQ_B
    mxc_request_iomux(MX31_PIN_KEY_ROW6, OUTPUTCONFIG_GPIO, INPUTCONFIG_GPIO);     	// ATA_INTRQ_B
    mxc_request_iomux(MX31_PIN_KEY_COL5, OUTPUTCONFIG_GPIO, INPUTCONFIG_GPIO);     	// ATA_DA0
    mxc_request_iomux(MX31_PIN_KEY_COL6, OUTPUTCONFIG_GPIO, INPUTCONFIG_GPIO);   	// ATA_DA1
    mxc_request_iomux(MX31_PIN_KEY_COL7, OUTPUTCONFIG_GPIO, INPUTCONFIG_GPIO);	// ATA_DA2
    mxc_request_iomux(MX31_PIN_KEY_ROW7, OUTPUTCONFIG_GPIO, INPUTCONFIG_GPIO);     	// ATA_BUFFER_DIR
...
int gpio_usbotg_hs_active(void)
{
	...
	//JADE create for seting ISP1504 power
	//MCU1_2 is nagtive for ISP1504power
	mxc_request_iomux(MX31_PIN_GPIO1_2, OUTPUTCONFIG_GPIO,INPUTCONFIG_GPIO);
	gpio_direction_output(IOMUX_TO_GPIO(MX31_PIN_GPIO1_2), 0);
...
void gpio_usbotg_hs_inactive(void)
{
	...
	gpio_direction_output(IOMUX_TO_GPIO(MX31_PIN_GPIO1_2), 1);
